...
<div style="display:flex; justify-content:space-between; background:yellow; margin-bottom:12px">
        <h4 style="padding:0; margin:0">Laba Kotor</h4>  <p style="padding:0; margin:0">{{handleCurrency(harta.valueTotal - modal.valueTotal )}}</p>
    </div>
<el-tree
:data="listKewajiban"
default-expand-all
...
<div style="display:flex; justify-content:space-between; background:yellow; margin-bottom:12px">
        <h4 style="padding:0; margin:0">Total Biaya</h4>  <p style="padding:0; margin:0">{{handleCurrency(kewajiban.valueTotal)}}</p>
    </div>

<div style="display:flex; justify-content:space-between; background:yellow; margin-bottom:12px">
        <h4 style="padding:0; margin:0">Laba/Rugi</h4>  <p style="padding:0; margin:0">{{handleCurrency(harta.valueTotal - modal.valueTotal - kewajiban.valueTotal )}}</p>
    </div>
