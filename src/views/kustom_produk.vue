...
<div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        <el-form label-position="top" :inline="true" ref="dataForm" :rules="rules" :model="temp" label-width="180px" style="width: 100%; margin-left:50px;">
            ...
            <el-form-item class="k" label="Total">
                <v-money-spinner v-model="custom" v-bind="config"></v-money-spinner>
            </el-form-item>
...
export default {
    ...
    methods: {
        getList() {
            ...
            axios.get(`/product/price/detail/${this.$route.params.id}`).then(response => {
                console.log(response)
                this.list = response.data.price.sort((a, b) => (a.name > b.name) ? 1 : ((b.name > a.name) ? -1 : 0))
                console.log(this.list)
                this.total = response.data.price.length
        ...
        createData() {
            ...
            axios.post('/product/price/create', data)
                .then((response) => {
                    this.loading = false
        ...
        handleDelete(row, index) {
            ...
            axios.delete(`/product/price/delete/${row.id}`)
                .then((response) => {
                    this.listLoading = false
                    this.loading = false
